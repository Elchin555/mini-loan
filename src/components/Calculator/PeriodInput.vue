...
<template>
  <div class="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-4 justify-center">
    <div class="w-full md:w-2/3 flex flex-col space-y-2">
      ...
      <div class="flex items-center justify-between text-[#21093A] text-sm translate-y-2">
        <span>2 months</span>
        <span>72 months</span>
      </div>
    </div>
    <div class="w-full md:w-1/3 relative">
      ...
      <select id="location" v-model="localSelectedPeriod" class="dropDown w-full p-2 border border-[#60378B] rounded-md focus:outline-none bg-white">
